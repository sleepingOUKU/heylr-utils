 ...
 * @author youji.zj
 */
public class MySqlLog extends LogBase {
    private static final Logger heliumRecordLog = Logger.getLogger("mysqlLog");
    private static final String FILE_NAME = "mysql.log";
    ...
    public static void error(String detail, Object... params) {
        log(heliumRecordLog, logHandler, Level.WARNING, detail, params);
    }

    public static void error(String detail, Throwable e) {
        log(heliumRecordLog, logHandler, Level.WARNING, detail, e);
    }
