package com.heylr.spi.base;

import com.heylr.spi.base.api.Spi;
import com.heylr.spi.base.api.SpiAdaptive;
import com.heylr.spi.base.api.SpiConf;
import com.heylr.spi.base.complie.CodeUtil;
import com.heylr.spi.base.complie.GroovyCompile;
...
import com.heylr.spi.base.selector.ParamsSelector;
import com.heylr.spi.base.selector.api.ISelector;
import com.heylr.spi.base.selector.api.SelectorWrapper;
...
public class SpiLoader<T> {
    ...
    private SelectorWrapper initSelector(Class<? extends ISelector> clz) {
        ...
        try {
            ...
            Assert.assertTrue(paramClz != null);
